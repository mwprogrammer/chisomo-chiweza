      ...
      <section className="w-full max-w-2xl mx-auto space-y-8 bg-white print:space-y-6">
        ...
        <Section>
          ...
          <p className="font-mono text-sm text-muted-foreground">
            I also write about my thoughts and experiences engineering software
            in Malawi on my blog{" "}
            <a
              className="underline"
              href="https://malawianprogrammer.notion.site/A-Malawian-Programmer-s-blog-00ecb817ea14446a9a0456c78758f425"
            >
              here
            </a>
            .
                ...
                <CardHeader>
                  <div className="flex items-center justify-between text-sm gap-x-2">
                    <h3 className="inline-flex items-center justify-center font-semibold leading-none gap-x-1">
                      <a className="text-lg hover:underline" href={work.link}>
                        {work.company}
                      </a>
          ...
          {RESUME_DATA.education.map((education) => {
            return (
              <Card key={education.school}>
                <CardHeader>
                  <div className="flex items-center justify-between text-lg gap-x-2">
